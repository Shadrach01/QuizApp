...
import com.example.quizapp.localRepository.ReligiousStudyDataSource
...
class ReligiousKnowledgeViewModel() : ViewModel() {
    ...
    init {
        viewModelScope.launch {
            // Questions
            val questions = ReligiousStudyDataSource.questions
