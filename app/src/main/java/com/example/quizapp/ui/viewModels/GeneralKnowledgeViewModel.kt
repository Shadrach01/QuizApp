...
import com.example.quizapp.localRepository.GeneralKnowledgeDataSource
...
class GeneralKnowledgeViewModel() : ViewModel() {
    ...
    init {
        viewModelScope.launch {
            // Questions
            val questions = GeneralKnowledgeDataSource.questions
